...
int func_146(char* sParam0, int iParam1) // Position - 0xAE77 (44663)
{
	int num;
	const char* str;
	Hash hashKey;
...
int func_154(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xB1A0 (45472)
{
	int i;
...
void func_155(int iParam0, int iParam1) // Position - 0xB2D7 (45783)
{
	int i;
