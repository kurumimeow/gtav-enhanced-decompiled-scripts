...
Hash func_192(Hash hParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0x13294 (78484)
{
	var outProp;
	int componentId;
	int num;
...
BOOL func_196(Ped pedParam0, int iParam1, ePedComponentType epctParam2) // Position - 0x13866 (79974)
{
	BOOL i;
	BOOL j;
...
BOOL func_197(Ped pedParam0, int iParam1) // Position - 0x13907 (80135)
{
...
BOOL func_199(Ped pedParam0, ePedComponentType epctParam1) // Position - 0x139BE (80318)
{
	int pedPropIndex;
...
BOOL func_205(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x13DDF (81375)
{
	Hash entityModel;
	BOOL flag;
	Hash hash;
...
BOOL func_206(Hash hParam0, int iParam1, BOOL bParam2, var uParam3) // Position - 0x1423B (82491)
{
	Hash componentHash;
...
BOOL func_207(Hash hParam0, int iParam1, BOOL bParam2, var uParam3) // Position - 0x142E4 (82660)
{
	Hash componentHash;
	int shopPedApparelVariantComponentCount;
	int i;
...
BOOL func_208(Hash hParam0, int iParam1, BOOL bParam2, Hash hParam3) // Position - 0x1438C (82828)
{
	switch (hParam0)
	{
		case joaat("MP_F_Freemode_01"):
...
BOOL func_209(Hash hParam0, int iParam1, int iParam2, BOOL bParam3, var uParam4, int iParam5) // Position - 0x143DF (82911)
{
	var unk;
	int i;
...
BOOL func_210(Hash hParam0, int iParam1, BOOL bParam2, Hash hParam3) // Position - 0x149E3 (84451)
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
BOOL func_211(Hash hParam0, int iParam1, BOOL bParam2, Hash hParam3) // Position - 0x14C60 (85088)
{
	if (hParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 6)
...
BOOL func_212(Hash hParam0, int iParam1, BOOL bParam2, Hash hParam3) // Position - 0x15085 (86149)
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
BOOL func_213(Hash hParam0, int iParam1, BOOL bParam2) // Position - 0x15378 (86904)
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
struct<14> func_221(Hash hParam0, int iParam1, BOOL bParam2, Hash hParam3) // Position - 0x18007 (98311)
{
	func_267();
