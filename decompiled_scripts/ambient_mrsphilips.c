...
int func_147(char* sParam0, int iParam1) // Position - 0xAE6D (44653)
{
	int num;
	const char* str;
	Hash hashKey;
...
int func_155(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xB196 (45462)
{
	int i;
...
void func_156(int iParam0, int iParam1) // Position - 0xB2CD (45773)
{
	int i;
