					...
					if (!IS_BIT_SET(iLocal_237, 5))
					{
						if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) == 0)
						{
							...
							if (!PED::IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID()))
							{
								...
								if (!IS_BIT_SET(iLocal_237, 2))
								{
									...
									MISC::CLEAR_BIT(&iLocal_237, 3);
									func_289("FM_CTUT_CAR" /*Get a vehicle.*/, false);
							...
							else
							{
								...
								if (!func_249(vehiclePedIsIn, false, &unk) || !func_248(vehiclePedIsIn) || func_247(ENTITY::GET_ENTITY_MODEL(vehiclePedIsIn)))
								{
									...
									if (!IS_BIT_SET(iLocal_237, 7))
									{
										func_289("FM_CTUT_ANO" /*Get a vehicle.*/, false);
								...
								else
								{
									...
									if (!func_235() || func_235() && PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()))
									{
										if (!IS_BIT_SET(iLocal_237, 3))
										{
											func_289("FM_CTUT_MOD" /*Go to Los Santos Customs.*/, false);
						...
						else
						{
							if (!IS_BIT_SET(iLocal_237, 10))
							{
								...
								{
									func_289("FM_IHELP_LCP" /*Lose the Cops.*/, false);
						...
						if (func_235())
						{
							...
							if (!IS_BIT_SET(iLocal_237, 9))
							{
								if (func_206())
								{
									...
									if (func_208("FM_CTUT_MOD" /*Go to Los Santos Customs.*/))
										func_24();
								}
							}
							...
							if (func_205())
							{
								...
								if (func_208("FM_CTUT_RSP" /*Get your vehicle resprayed.*/) || func_208("FM_IHELP_PTRK" /*Purchase a Tracker for your vehicle.*/) || func_208("FM_IHELP_PINS" /*Purchase Insurance for your vehicle.*/))
									func_24();
							}
							else if (IS_BIT_SET(iLocal_237, 9))
							{
								if (func_201(PLAYER::PLAYER_ID()) || !func_199() && func_198())
								{
									...
									if (num > 0)
										if (!func_208("FM_CTUT_REP" /*Get your vehicle repaired.*/))
											func_289("FM_CTUT_REP" /*Get your vehicle repaired.*/, false);
									else if (!func_189())
										if (!func_208("FM_CTUT_RSP" /*Get your vehicle resprayed.*/))
											func_289("FM_CTUT_RSP" /*Get your vehicle resprayed.*/, false);
									else if (!func_187())
										if (!func_208("FM_IHELP_PTRK" /*Purchase a Tracker for your vehicle.*/))
											func_289("FM_IHELP_PTRK" /*Purchase a Tracker for your vehicle.*/, false);
									else if (!func_184())
										if (!func_208("FM_IHELP_PINS" /*Purchase Insurance for your vehicle.*/))
											func_289("FM_IHELP_PINS" /*Purchase Insurance for your vehicle.*/, false);
								}
							}
						}
						else if (IS_BIT_SET(iLocal_237, 9))
