...
Hash func_195(Hash hParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0x134A8 (79016)
{
	var outProp;
	int componentId;
	int num;
...
BOOL func_199(Ped pedParam0, int iParam1, ePedComponentType epctParam2) // Position - 0x13A7A (80506)
{
	BOOL i;
	BOOL j;
...
BOOL func_200(Ped pedParam0, int iParam1) // Position - 0x13B1B (80667)
{
...
BOOL func_202(Ped pedParam0, ePedComponentType epctParam1) // Position - 0x13BD2 (80850)
{
	int pedPropIndex;
...
BOOL func_208(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x13FF3 (81907)
{
	Hash entityModel;
	BOOL flag;
	Hash hash;
	...
	entityModel = ENTITY::GET_ENTITY_MODEL(pedParam0);
	Global_79347[1 /*14*/] = { func_224(entityModel, iParam1, bParam2, -1) };
	hash = Global_2883588;
			...
			if (unk[num] != -99)
			{
				if (!func_208(pedParam0, num, unk[num]))
				{
							...
							if (!func_208(pedParam0, 14, unk18[i]))
							{
								for (j = 0; j <= 19; j = j + 1)
								{
									...
									if (Global_79347[2 /*14*/].f_12 == i)
									{
										...
										{
											if (!func_212(entityModel, bParam2, 14, j, &unk, &Global_79347[2 /*14*/]))
											{
												Global_2883588 = hash;
												Global_2883589 = hash2;
												return false;
					...
					else
					{
						...
						Global_79347[2 /*14*/] = { func_224(entityModel, num, flag, -1) };
					
						if (!func_212(entityModel, bParam2, num, flag, &unk, &Global_79347[2 /*14*/]))
						{
							Global_2883588 = hash;
							Global_2883589 = hash2;
							return false;
...
BOOL func_209(Hash hParam0, int iParam1, BOOL bParam2, var uParam3) // Position - 0x14450 (83024)
{
	Hash componentHash;
...
BOOL func_210(Hash hParam0, int iParam1, BOOL bParam2, var uParam3) // Position - 0x144F9 (83193)
{
	Hash componentHash;
	int shopPedApparelVariantComponentCount;
	int i;
...
BOOL func_211(Hash hParam0, int iParam1, BOOL bParam2, Hash hParam3) // Position - 0x145A1 (83361)
{
	switch (hParam0)
	{
		case joaat("MP_F_Freemode_01"):
...
BOOL func_212(Hash hParam0, int iParam1, int iParam2, BOOL bParam3, var uParam4, int iParam5) // Position - 0x145F4 (83444)
{
	var unk;
	int i;
...
BOOL func_213(Hash hParam0, int iParam1, BOOL bParam2, Hash hParam3) // Position - 0x14BF8 (84984)
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (bParam2 >= 327)
					{
						...
						return FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, joaat("HAT"), 1) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_195(hParam0, bParam2, 14, 3), -1842686353, 1);
					}
					break;
				...
				case 1:
					if (bParam2 >= 26)
					{
						...
						return FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, joaat("HAT"), 0) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_195(hParam0, bParam2, 1, 3), -1842686353, 0);
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (bParam2 >= 327)
					{
						...
						return FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, joaat("HAT"), 1) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_195(hParam0, bParam2, 14, 4), -1842686353, 1);
					}
					break;
				...
				case 1:
					if (bParam2 >= 26)
					{
						...
						return FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, joaat("HAT"), 0) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_195(hParam0, bParam2, 1, 4), -1842686353, 0);
					}
					break;
			}
			break;
...
BOOL func_214(Hash hParam0, int iParam1, BOOL bParam2, Hash hParam3) // Position - 0x14E75 (85621)
{
	if (hParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 6)
...
BOOL func_215(Hash hParam0, int iParam1, BOOL bParam2, Hash hParam3) // Position - 0x1529A (86682)
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
BOOL func_216(Hash hParam0, int iParam1, BOOL bParam2) // Position - 0x1558D (87437)
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
struct<14> func_224(Hash hParam0, int iParam1, BOOL bParam2, Hash hParam3) // Position - 0x1821B (98843)
{
	func_270();
...
int func_280(Hash hParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x34486 (214150)
{
	Hash componentHash;
