...
void func_150(BOOL bParam0, Hash hParam1, int iParam2) // Position - 0x807F (32895)
{
	if (func_174())
	{
		...
		if (func_160(PLAYER::PLAYER_ID()))
		{
			...
			Global_1845270[PLAYER::PLAYER_ID() /*892*/].f_206.f_6 = func_157(bParam0, true);
		}
...
BOOL func_161(int iParam0, int iParam1) // Position - 0x8919 (35097)
{
	Hash statHash;
	int outValue;
...
BOOL func_162(Player plParam0) // Position - 0x8948 (35144)
{
...
BOOL func_173(int iParam0, BOOL bParam1, int iParam2) // Position - 0x9132 (37170)
{
	iParam2 == 0;
	bParam1;
	...
	*iParam0 = iParam9;
	...
	else
	{
		...
		if (iParam1 == 11 || iParam1 == 4 || iParam1 == 6 || iParam1 == 1 || iParam1 == 14 || iParam1 == 2 || iParam1 == 8 || iParam1 == 9 || iParam1 == 10 || iParam1 == 7 || iParam1 == 12)
		{
			...
			flag = func_161(func_245(iParam1, iParam0->f_2), Global_79344);
		
			if (IS_BIT_SET(flag, iParam0->f_1))
				MISC::SET_BIT(&(iParam0->f_6), 1);
		
			flag = func_161(func_244(iParam1, iParam0->f_2), Global_79344);
			...
			{
				flag = func_161(num, Global_79344);
...
BOOL func_266(int iParam0, int iParam1) // Position - 0x2295B (141659)
{
	BOOL flag;
...
BOOL func_300(var uParam0, int iParam1) // Position - 0x32906 (207110)
{
	BOOL flag;
