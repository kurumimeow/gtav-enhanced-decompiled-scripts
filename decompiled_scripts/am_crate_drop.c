...
void func_150(BOOL bParam0, Hash hParam1, int iParam2) // Position - 0x807F (32895)
{
	if (func_174())
	{
		...
		if (func_160(PLAYER::PLAYER_ID()))
		{
			...
			Global_1845274[PLAYER::PLAYER_ID() /*877*/].f_198.f_6 = func_157(bParam0, true);
		}
	
		func_154(640, bParam0, -1, true);
		func_154(641, func_157(bParam0, true), -1, true);
...
void func_154(int iParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x8279 (33401)
{
	Hash statName;
...
BOOL func_157(BOOL bParam0, BOOL bParam1) // Position - 0x82F0 (33520)
{
	bParam1;
	return func_158(bParam0, 0);
}

int func_158(BOOL bParam0, int iParam1) // Position - 0x8304 (33540)
{
	int i;
	int value;
	int value2;
	...
	for (i = 0; i <= 100; i = i + 1)
	{
		...
		if (func_159(num) == bParam0)
		{
			value = num;
			value2 = num;
		}
		else if (func_159(num) < bParam0)
		{
			if (value2 == num)
				value2 = value2 + 1;
			else
...
BOOL func_159(int iParam0) // Position - 0x83BF (33727)
{
	int num;
	int num2;
...
BOOL func_161(int iParam0, int iParam1) // Position - 0x8922 (35106)
{
	Hash statHash;
	int outValue;
...
BOOL func_162(Player plParam0) // Position - 0x8951 (35153)
{
...
void func_163(int iParam0, int iParam1, int iParam2) // Position - 0x89A8 (35240)
{
	...
	flag = func_161(iParam0, func_156(iParam2));
	flag = flag + iParam1;
	func_154(iParam0, flag, iParam2, true);
	return;
}
...
int func_172(int iParam0) // Position - 0x90D7 (37079)
{
	...
	if (func_173(8000, false, 0) > false)
...
BOOL func_173(int iParam0, BOOL bParam1, int iParam2) // Position - 0x913B (37179)
{
	iParam2 == 0;
	bParam1;
	...
	*iParam0 = iParam9;
	...
	else
	{
		...
		if (iParam1 == 11 || iParam1 == 4 || iParam1 == 6 || iParam1 == 1 || iParam1 == 14 || iParam1 == 2 || iParam1 == 8 || iParam1 == 9 || iParam1 == 10 || iParam1 == 7 || iParam1 == 12)
		{
			...
			flag = func_161(func_245(iParam1, iParam0->f_2), Global_79548);
		
			if (IS_BIT_SET(flag, iParam0->f_1))
				MISC::SET_BIT(&(iParam0->f_6), 1);
		
			flag = func_161(func_244(iParam1, iParam0->f_2), Global_79548);
		
			if (IS_BIT_SET(flag, iParam0->f_1))
				MISC::SET_BIT(&(iParam0->f_6), 2);
		
			if (func_243(iParam1, iParam0->f_2, &num))
			{
				flag = func_161(num, Global_79548);
...
BOOL func_264(int iParam0, int iParam1) // Position - 0x22CEA (142570)
{
	...
	flag = func_266(iParam0, iParam1);
	num = iParam0;
	return IS_BIT_SET(flag, func_265(num));
}
...
BOOL func_266(int iParam0, int iParam1) // Position - 0x22D26 (142630)
{
	BOOL flag;

	flag = func_161(func_267(iParam0), iParam1);
	return flag;
}
...
void func_291() // Position - 0x31422 (201762)
{
	...
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		flag = SYSTEM::ROUND(50f * Global_262145.f_108);
		func_154(817, flag, -1, true);
...
BOOL func_300(var uParam0, int iParam1) // Position - 0x32D59 (208217)
{
	BOOL flag;

	flag = func_161(func_301(uParam0), iParam1);
	return flag;
}
